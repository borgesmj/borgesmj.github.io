...
export const projects = [
  ...
  },
  {
    ...
    description:
      "A Telegram bot built with Node.js and Supabase for effortless expense and income tracking. It offers intuitive commands for adding, updating, and viewing financial data, ensuring a seamless and user-friendly experience.",
    technologies: ["JavaScript", "NodeJs", "Supabase", "Telegram"],
    repositoryLink: "https://github.com/borgesmj/telegram_app_bot",
    liveDemo: "https://t.me/saburo_Finance_bot",
    year: 2025,
    features: [
