  ...
  const proyectos = [
    {
      ...
      Descripcion: "Primer proyecto para una empresa real. Creando una tienda virtual para un local de ventas de licores en Venezela, que tiene un carrito de compras, al que puedes acceder, eliminar o agregar mas productos, y enviar el pedido directamente por un mensaje de WhatsApp.",
