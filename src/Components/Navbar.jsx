...
console.log(currentPath)
  ...
  return (
    <nav className="navbar bg-background-100 w-dvw text-white py-2 px-1 bottom-0 left-0 z-50 fixed md:left-12 md:h-full md:w-[13rem] md:top-0 md:bottom-8 md:border-r-[1px] md:border-r-solid md:border-t-none md:border-accent-100 md:flex md:flex-col md:justify-center lg:left-16  font-mono xl:left-28 2xl:left-60">
